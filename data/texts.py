TEXTS = {
    ...
    "delete_warning": (
        "\n\n<b>‼️ Сообщение будет удалено через {seconds} сек. ‼️</b> Скопируйте текст, если он важен."
    ),
    "mute_applied": (
    ...
    "kick_applied": (
        "🚫 {name}, из-за серии нарушений в количестве: <b>{violations_count}</b> вы исключены из группы.\n"
        "Вы можете присоединиться обратно позднее, но просим соблюдать правила."
    ),
    "kick_ban_applied": (
        "⛔️ {name}, из-за серии нарушений в количестве: <b>{violations_count}</b> вы исключены из группы на <b>{minutes}</b> мин. (до {date_str}).\n"
        "Пожалуйста, учтите это и соблюдайте правила после возвращения."
    ),
    "ban_applied": (
        "🚷 {name}, из-за многократных нарушений в количестве: <b>{violations_count}</b> вы заблокированы в группе навсегда.\n"
